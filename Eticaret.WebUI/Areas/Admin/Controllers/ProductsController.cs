    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (product != null)
            {
                ...
                {
                    FileHelper.FileRemover(product.Image, "/Img/Products/");// silmek istediğimizi default olarak değil özel bir klasörden sileceksek 2.parametreyi "/Img/Categories/ şekline vermeliyiz.Yoksa sunucudan silme işlemi gerçekleşmez.
                }
